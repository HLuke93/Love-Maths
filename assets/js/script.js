...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document
    .getElementById("answer-box").addEventListener("keydown", function(event) {
        if (event.key === "Enter") {
            checkAnswer();
        }
    })
...
function checkAnswer() {
  ...
  if (isCorrect) {
      ...
      alert(`Ahhh, you answered ${userAnswer}. The correct answer is ${calculatedAnswer[0]}!`);
...
/**
 * Gets the current tally of incorrect score from the DOM and increments it by one
 */
